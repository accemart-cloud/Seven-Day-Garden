export type ActivityGroupSource = [string, string[]];

export const PHYS: ActivityGroupSource[] = [
  ['Aerobic & Endurance', ['Brisk Walking', 'Swimming', 'Cycling', 'Running/Jogging', 'Rowing', 'Hiking', 'Dancing', 'Jump Roping']],
  ['Strength & Core Optimization', ['Free-Weight Training', 'Bodyweight Exercises', 'Resistance Band Work', 'Pilates', 'Kettlebell Training']],
  ['Flexibility, Balance & Recovery', ['Tai Chi', 'Yoga', 'Dynamic Stretching', 'Pelvic Floor Exercises (Kegels)']],
  ['Lifestyle & Recreational Movement', ['Active Gardening', 'Tennis or Pickleball', 'Kayaking']],
];
...
export const MENT: ActivityGroupSource[] = [
  ...
  ['Mindfulness, Rest & Neurological Recovery', ['Mindful Meditation', 'Deep Breathing Exercises', 'Restorative Sleep Tracking']],
];
